...
static uint32_t word_time = millis()-2000;
...
GD.ColorA(255);
GD.Tag(BUTTON_INSTRUCT); GD.cmd_text((GD.w/2)-1,200+1,20,OPT_CENTER,"HOW TO PLAY");
GD.ColorA(alpha2);
alpha2-=1;
GD.ColorRGB(0x6b1f53);
GD.Tag(BUTTON_GOAL); GD.cmd_text(GD.w/2,180,20,OPT_CENTER, "PRESS TO PLAY");
GD.ColorA(255);
GD.Tag(BUTTON_INSTRUCT); GD.cmd_text(GD.w/2,200,20,OPT_CENTER,"HOW TO PLAY");
goal_time = millis();
GD.RestoreContext();
...
GD.cmd_text((GD.w/2),(GD.h/2),20,OPT_CENTER, "Collect as many as you can so that Hoppy can survive");
GD.cmd_text((GD.w/2),(GD.h/2)+30,20,OPT_CENTER,"the harsh winter ahead.");
GD.ColorRGB(0xff78ae);
GD.Tag(BUTTON_GOAL); GD.cmd_text((GD.w/2)-1,180+1,20,OPT_CENTER, "PRESS TO PLAY");
GD.ColorRGB(0x6b1f53);
GD.Tag(BUTTON_GOAL); GD.cmd_text(GD.w/2,180,20,OPT_CENTER, "PRESS TO PLAY");
...
GD.cmd_text((GD.w/2),(GD.h/2)+10,21,OPT_CENTER, "Collect 60 pizzas. Be careful! If you reach");
GD.cmd_text((GD.w/2),(GD.h/2)+30,21,OPT_CENTER, "-5 points, Hoppy will starve.");
GD.ColorRGB(0xffb0f7);
GD.cmd_text((GD.w/2)-1,(GD.h/2)+11,21,OPT_CENTER, "Collect 60 pizzas. Be careful! If you reach");
GD.cmd_text((GD.w/2)-1,(GD.h/2)+31,21,OPT_CENTER, "-5 points, Hoppy will starve.");
GD.RestoreContext(); 
}
